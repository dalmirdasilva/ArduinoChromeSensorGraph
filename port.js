...
SerialPort.prototype.onConnect = function (info) {
    ...
    chrome.serial.setPaused(info.connectionId, false, function (a) {
        chrome.serial.getInfo(info.connectionId, function (i) {
            console.log(i)
        })
    })
...
SerialPort.prototype.onReceive = function (info) {
    console.log(info);
    console.log(this.connectionId, info.connectionId);
